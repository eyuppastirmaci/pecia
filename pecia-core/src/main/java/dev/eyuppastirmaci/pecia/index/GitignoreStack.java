...
/** Maintains nested gitignore scopes during a depth-first directory traversal. */
public final class GitignoreStack {
    ...
    public boolean isIgnored(Path path, boolean isDirectory) {
        // The nearest .gitignore wins, so ask the deepest scope first and stop at the first definitive
        // answer.
